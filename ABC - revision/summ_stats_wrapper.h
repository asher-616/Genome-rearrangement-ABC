...
vector<vector<double> > getStatVec(genomes &);// This function gets an MSA as input and return a vector of summary statistics.//A.M changed to get a genomes object
vector<vector<double> > getStatVec(string inputFile); // this function return the summary statistics vector from an input MSA read from a file 
											 //A.M don't have this. will be complicated to write
